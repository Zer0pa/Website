...
<h2 class="mono-label text-secondary mb-6">02 // AUTHORITY STATUS</h2>
<div class="space-y-6">
...
<h2 class="mono-label text-secondary mb-8">06 // VERIFICATION STATUS</h2>
...
<h3 class="mono-label text-white mb-2">08 // {esc(repo_short)}_VISUALIZER</h3>
