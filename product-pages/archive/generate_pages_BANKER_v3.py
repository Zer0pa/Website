...
<!-- ZONE 8: WHAT THIS IS -->
<div class="lg:col-span-8 p-12 border-r border-outline-variant" style="background: linear-gradient(to bottom, #0a0a0a 0%, #ffffff 15%, #ffffff 55%, #0a0a0a 90%);">
<h2 class="mono-label text-black mb-6">08 // WHAT THIS IS</h2>
<div class="text-xl font-body leading-relaxed max-w-3xl [&>strong]:text-black [&>p:first-child]:text-gray-700 [&>p:nth-child(2)]:text-black [&>p:nth-child(n+3)]:text-gray-300 space-y-4">
{wti_html}
</div>
</div>
...
<div class="flex flex-col gap-4 w-80 shrink-0 relative z-10">
<a href="{esc(data['url'])}" target="_blank" rel="noreferrer" class="bg-white text-black py-6 mono-label font-bold text-xl hover:bg-secondary transition-all text-center block">CLONE THIS REPO</a>
<a href="{esc(data['url'])}/blob/main/LICENSE" target="_blank" rel="noreferrer" class="border border-white text-white py-6 mono-label font-bold text-xl hover:bg-white hover:text-black transition-all text-center block">DOWNLOAD LICENSE</a>
</div>
</div>
</footer>
</main>
